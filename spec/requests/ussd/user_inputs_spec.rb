describe "User input" do
  ...
  let!(:user_input1) { create(:user_input, menu_item: sub_menu_item, content: "What is your blood pressure reading?") }
  let!(:user_input2) { create(:user_input, menu_item: sub_menu_item, content: "What is your heart rate reading?") }
  ...
  it "provide user health readings input" do
    ...
    post(ussd_callback_path(service_code.country_code, service_code.short_name), params: params.merge(text: "90"))
